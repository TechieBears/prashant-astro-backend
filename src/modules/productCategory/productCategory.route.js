...
router.use(protect);
router.post('/create', authorize('admin', 'employee'), ProductCategoryController.createProductCategory);
...
router.put('/update', authorize('admin', 'employee'), ProductCategoryController.updateProductCategory);
